...
{{
var G__8754 = cljs.core.pop.call(null,v__$1);
v__$1 = G__8754;
continue;
}
} else
...
{var pred__8758 = cljs.core._EQ_;var expr__8759 = limit;if(cljs.core.truth_(pred__8758.call(null,1,expr__8759)))
...
var G__8761 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__8762 = (limit__$1 - 1);
var G__8763 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__8761;
limit__$1 = G__8762;
parts = G__8763;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___8765 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___8765))
{var replacement_8766 = temp__4090__auto___8765;buffer.append([cljs.core.str(replacement_8766)].join(''));
} else
{buffer.append(ch);
}
{
