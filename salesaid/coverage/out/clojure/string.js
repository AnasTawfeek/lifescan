...
{{
var G__44629 = cljs.core.pop.call(null,v__$1);
v__$1 = G__44629;
continue;
}
} else
...
{var pred__44633 = cljs.core._EQ_;var expr__44634 = limit;if(cljs.core.truth_(pred__44633.call(null,1,expr__44634)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__44633.call(null,2,expr__44634)))
...
var G__44636 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__44637 = (limit__$1 - 1);
var G__44638 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__44636;
limit__$1 = G__44637;
parts = G__44638;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___44640 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___44640))
{var replacement_44641 = temp__4090__auto___44640;buffer.append([cljs.core.str(replacement_44641)].join(''));
} else
{buffer.append(ch);
}
{
var G__44642 = (index + 1);
index = G__44642;
continue;
}
}
