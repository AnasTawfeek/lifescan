...
{{
var G__11656 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11656;
continue;
}
} else
...
{var pred__11660 = cljs.core._EQ_;var expr__11661 = limit;if(cljs.core.truth_(pred__11660.call(null,1,expr__11661)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11660.call(null,2,expr__11661)))
...
var G__11663 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11664 = (limit__$1 - 1);
var G__11665 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11663;
limit__$1 = G__11664;
parts = G__11665;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___11667 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___11667))
{var replacement_11668 = temp__4090__auto___11667;buffer.append([cljs.core.str(replacement_11668)].join(''));
} else
{buffer.append(ch);
}
{
var G__11669 = (index + 1);
index = G__11669;
continue;
}
}
