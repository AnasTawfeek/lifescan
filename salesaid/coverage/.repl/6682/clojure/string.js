...
{{
var G__8854 = cljs.core.pop.call(null,v__$1);
v__$1 = G__8854;
continue;
}
} else
...
{var pred__8858 = cljs.core._EQ_;var expr__8859 = limit;if(cljs.core.truth_(pred__8858.call(null,1,expr__8859)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__8858.call(null,2,expr__8859)))
...
var G__8861 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__8862 = (limit__$1 - 1);
var G__8863 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__8861;
limit__$1 = G__8862;
parts = G__8863;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___8865 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___8865))
{var replacement_8866 = temp__4090__auto___8865;buffer.append([cljs.core.str(replacement_8866)].join(''));
} else
{buffer.append(ch);
}
{
