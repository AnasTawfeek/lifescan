...
{var pred__15406 = cljs.core._EQ_;var expr__15407 = limit;if(cljs.core.truth_(pred__15406.call(null,1,expr__15407)))
...
{var ch = s.charAt(index);var temp__4090__auto___15413 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___15413))
{var replacement_15414 = temp__4090__auto___15413;buffer.append([cljs.core.str(replacement_15414)].join(''));
} else
{buffer.append(ch);
}
{
