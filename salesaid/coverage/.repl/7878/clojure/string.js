...
{{
var G__12760 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12760;
continue;
}
} else
...
{var pred__12764 = cljs.core._EQ_;var expr__12765 = limit;if(cljs.core.truth_(pred__12764.call(null,1,expr__12765)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12764.call(null,2,expr__12765)))
...
var G__12767 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12768 = (limit__$1 - 1);
var G__12769 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12767;
limit__$1 = G__12768;
parts = G__12769;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12771 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12771))
{var replacement_12772 = temp__4090__auto___12771;buffer.append([cljs.core.str(replacement_12772)].join(''));
} else
{buffer.append(ch);
}
{
var G__12773 = (index + 1);
index = G__12773;
continue;
}
}
