...
{{
var G__257043 = cljs.core.pop.call(null,v__$1);
v__$1 = G__257043;
continue;
}
} else
...
{var pred__257047 = cljs.core._EQ_;var expr__257048 = limit;if(cljs.core.truth_(pred__257047.call(null,1,expr__257048)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__257047.call(null,2,expr__257048)))
...
var G__257050 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__257051 = (limit__$1 - 1);
var G__257052 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__257050;
limit__$1 = G__257051;
parts = G__257052;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___257054 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___257054))
{var replacement_257055 = temp__4090__auto___257054;buffer.append([cljs.core.str(replacement_257055)].join(''));
} else
{buffer.append(ch);
}
{
var G__257056 = (index + 1);
index = G__257056;
continue;
}
}
