...
{{
var G__16449 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16449;
continue;
}
} else
...
{var pred__16453 = cljs.core._EQ_;var expr__16454 = limit;if(cljs.core.truth_(pred__16453.call(null,1,expr__16454)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16453.call(null,2,expr__16454)))
...
var G__16456 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16457 = (limit__$1 - 1);
var G__16458 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16456;
limit__$1 = G__16457;
parts = G__16458;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___16460 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___16460))
{var replacement_16461 = temp__4090__auto___16460;buffer.append([cljs.core.str(replacement_16461)].join(''));
} else
{buffer.append(ch);
}
{
var G__16462 = (index + 1);
index = G__16462;
continue;
}
}
