...
{{
var G__19914 = cljs.core.pop.call(null,v__$1);
v__$1 = G__19914;
continue;
}
} else
...
{var pred__19918 = cljs.core._EQ_;var expr__19919 = limit;if(cljs.core.truth_(pred__19918.call(null,1,expr__19919)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__19918.call(null,2,expr__19919)))
...
var G__19921 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__19922 = (limit__$1 - 1);
var G__19923 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__19921;
limit__$1 = G__19922;
parts = G__19923;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___19925 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___19925))
{var replacement_19926 = temp__4090__auto___19925;buffer.append([cljs.core.str(replacement_19926)].join(''));
} else
{buffer.append(ch);
}
{
var G__19927 = (index + 1);
index = G__19927;
continue;
}
}
