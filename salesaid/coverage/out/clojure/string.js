...
{{
var G__336808 = cljs.core.pop.call(null,v__$1);
v__$1 = G__336808;
continue;
}
} else
...
{var pred__336812 = cljs.core._EQ_;var expr__336813 = limit;if(cljs.core.truth_(pred__336812.call(null,1,expr__336813)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__336812.call(null,2,expr__336813)))
...
var G__336815 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__336816 = (limit__$1 - 1);
var G__336817 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__336815;
limit__$1 = G__336816;
parts = G__336817;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___336819 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___336819))
{var replacement_336820 = temp__4090__auto___336819;buffer.append([cljs.core.str(replacement_336820)].join(''));
} else
{buffer.append(ch);
}
{
var G__336821 = (index + 1);
index = G__336821;
continue;
}
}
