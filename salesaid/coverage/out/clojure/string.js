...
{{
var G__35531 = cljs.core.pop.call(null,v__$1);
v__$1 = G__35531;
continue;
}
} else
...
{var pred__35535 = cljs.core._EQ_;var expr__35536 = limit;if(cljs.core.truth_(pred__35535.call(null,1,expr__35536)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__35535.call(null,2,expr__35536)))
...
var G__35538 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__35539 = (limit__$1 - 1);
var G__35540 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__35538;
limit__$1 = G__35539;
parts = G__35540;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___35542 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___35542))
{var replacement_35543 = temp__4090__auto___35542;buffer.append([cljs.core.str(replacement_35543)].join(''));
} else
{buffer.append(ch);
}
{
var G__35544 = (index + 1);
index = G__35544;
continue;
}
}
