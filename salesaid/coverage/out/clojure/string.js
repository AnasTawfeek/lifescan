...
{{
var G__56993 = cljs.core.pop.call(null,v__$1);
v__$1 = G__56993;
continue;
}
} else
...
{var pred__56997 = cljs.core._EQ_;var expr__56998 = limit;if(cljs.core.truth_(pred__56997.call(null,1,expr__56998)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__56997.call(null,2,expr__56998)))
...
var G__57000 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__57001 = (limit__$1 - 1);
var G__57002 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__57000;
limit__$1 = G__57001;
parts = G__57002;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___57004 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___57004))
{var replacement_57005 = temp__4090__auto___57004;buffer.append([cljs.core.str(replacement_57005)].join(''));
} else
{buffer.append(ch);
}
{
var G__57006 = (index + 1);
index = G__57006;
continue;
}
}
