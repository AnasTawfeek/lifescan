...
{{
var G__67149 = cljs.core.pop.call(null,v__$1);
v__$1 = G__67149;
continue;
}
} else
...
{var pred__67153 = cljs.core._EQ_;var expr__67154 = limit;if(cljs.core.truth_(pred__67153.call(null,1,expr__67154)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__67153.call(null,2,expr__67154)))
...
var G__67156 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__67157 = (limit__$1 - 1);
var G__67158 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__67156;
limit__$1 = G__67157;
parts = G__67158;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___67160 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___67160))
{var replacement_67161 = temp__4090__auto___67160;buffer.append([cljs.core.str(replacement_67161)].join(''));
} else
{buffer.append(ch);
}
{
var G__67162 = (index + 1);
index = G__67162;
continue;
}
}
