...
{{
var G__10552 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10552;
continue;
}
} else
...
{var pred__10556 = cljs.core._EQ_;var expr__10557 = limit;if(cljs.core.truth_(pred__10556.call(null,1,expr__10557)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10556.call(null,2,expr__10557)))
...
var G__10559 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10560 = (limit__$1 - 1);
var G__10561 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10559;
limit__$1 = G__10560;
parts = G__10561;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10563 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10563))
{var replacement_10564 = temp__4090__auto___10563;buffer.append([cljs.core.str(replacement_10564)].join(''));
} else
{buffer.append(ch);
}
{
var G__10565 = (index + 1);
index = G__10565;
continue;
}
}
