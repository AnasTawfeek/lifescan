...
{{
var G__8760 = cljs.core.pop.call(null,v__$1);
v__$1 = G__8760;
continue;
}
} else
...
{var pred__8764 = cljs.core._EQ_;var expr__8765 = limit;if(cljs.core.truth_(pred__8764.call(null,1,expr__8765)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__8764.call(null,2,expr__8765)))
...
var G__8767 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__8768 = (limit__$1 - 1);
var G__8769 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__8767;
limit__$1 = G__8768;
parts = G__8769;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___8771 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___8771))
{var replacement_8772 = temp__4090__auto___8771;buffer.append([cljs.core.str(replacement_8772)].join(''));
} else
{buffer.append(ch);
}
{
