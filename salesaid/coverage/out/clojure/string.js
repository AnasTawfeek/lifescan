...
{{
var G__416573 = cljs.core.pop.call(null,v__$1);
v__$1 = G__416573;
continue;
}
} else
...
{var pred__416577 = cljs.core._EQ_;var expr__416578 = limit;if(cljs.core.truth_(pred__416577.call(null,1,expr__416578)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__416577.call(null,2,expr__416578)))
...
var G__416580 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__416581 = (limit__$1 - 1);
var G__416582 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__416580;
limit__$1 = G__416581;
parts = G__416582;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___416584 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___416584))
{var replacement_416585 = temp__4090__auto___416584;buffer.append([cljs.core.str(replacement_416585)].join(''));
} else
{buffer.append(ch);
}
{
var G__416586 = (index + 1);
index = G__416586;
continue;
}
}
