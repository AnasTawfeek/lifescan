$(document).ready(function(){
  ...
  $('#verio .co').live('touchstart click', function(e){
    ...
    document.location = "veeva:gotoSlide(verio_v2.zip, BGM_01-2012_POA_v2)"; 
  });
  $('#mini .co').live('touchstart click', function(e){
    e.stopPropagation(); e.preventDefault();
    
    document.location = "veeva:gotoSlide(ultramini_v2.zip, BGM_01-2012_POA_v2)"; 
  });
  ...
  $("#veriosync .arrow").live('touchstart click', function(e) {
    e.stopPropagation(); e.preventDefault();
    document.location = "veeva:gotoSlide(yourpatientinsights_v2.zip, VerioSync_09-2013_POA_v2)";
  });
