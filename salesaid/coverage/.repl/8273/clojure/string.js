...
{{
var G__12001 = cljs.core.pop.call(null,v__$1);
v__$1 = G__12001;
continue;
}
} else
...
{var pred__12005 = cljs.core._EQ_;var expr__12006 = limit;if(cljs.core.truth_(pred__12005.call(null,1,expr__12006)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__12005.call(null,2,expr__12006)))
...
var G__12008 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__12009 = (limit__$1 - 1);
var G__12010 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__12008;
limit__$1 = G__12009;
parts = G__12010;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___12012 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___12012))
{var replacement_12013 = temp__4090__auto___12012;buffer.append([cljs.core.str(replacement_12013)].join(''));
} else
{buffer.append(ch);
}
{
var G__12014 = (index + 1);
index = G__12014;
continue;
}
}
