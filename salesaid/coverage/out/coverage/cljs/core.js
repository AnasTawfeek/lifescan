...
coverage.cljs.core.grids_view = (function grids_view(grids){var dom427675 = document.createElement("div");dom427675.className = "content full-width";
dom427675.appendChild((function (){var dom427676 = document.createElement("a");dom427676.className = "grid-button create-grid-button";
return dom427676;
})());
dom427675.appendChild(dommy.template.__GT_node_like.call(null,(function (){var iter__3986__auto__ = (function iter__427677(s__427678){return (new cljs.core.LazySeq(null,(function (){var s__427678__$1 = s__427678;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__427678__$1);if(temp__4092__auto__)
{var s__427678__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__427678__$2))
{var c__3984__auto__ = cljs.core.chunk_first.call(null,s__427678__$2);var size__3985__auto__ = cljs.core.count.call(null,c__3984__auto__);var b__427680 = cljs.core.chunk_buffer.call(null,size__3985__auto__);if((function (){var i__427679 = 0;while(true){
if((i__427679 < size__3985__auto__))
{var current_grid = cljs.core._nth.call(null,c__3984__auto__,i__427679);cljs.core.chunk_append.call(null,b__427680,coverage.cljs.core.grid_view.call(null,current_grid));
{
var G__427681 = (i__427679 + 1);
i__427679 = G__427681;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__427680),iter__427677.call(null,cljs.core.chunk_rest.call(null,s__427678__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__427680),null);
}
} else
{var current_grid = cljs.core.first.call(null,s__427678__$2);return cljs.core.cons.call(null,coverage.cljs.core.grid_view.call(null,current_grid),iter__427677.call(null,cljs.core.rest.call(null,s__427678__$2)));
}
} else
{return null;
}
...
coverage.cljs.core.grid_view = (function grid_view(grid){var dom427683 = document.createElement("a");if("grid-button coverage-grid-button")
{dom427683.className = [cljs.core.str(dom427683.className),cljs.core.str(" "),cljs.core.str("grid-button coverage-grid-button")].join('').trim();
} else
{}
if(cljs.core.truth_(new cljs.core.Keyword(null,"id","id",1013907597).cljs$core$IFn$_invoke$arity$1(grid)))
{dom427683.setAttribute("_id",new cljs.core.Keyword(null,"id","id",1013907597).cljs$core$IFn$_invoke$arity$1(grid));
} else
{}
return dom427683;
});
